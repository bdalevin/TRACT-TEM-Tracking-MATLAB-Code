function plot_meanfwhm(ZProjImage, RefinedPeaks)
...
%   Written by Barnaby Levin, ASU, 2017
    ...
    scatter(ax2, RefinedPeaks(:,1), RefinedPeaks(:,2), [], RefinedPeaks(:,3), 'filled', 'LineWidth',1.5);
    ...
    Ctitle = ylabel(cb2, 'Integrated Intensity'); % Give colorbar a title
