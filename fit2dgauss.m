...
QuickPoisson = sqrt(abs(mean(mean(Z)))*3.14159*4.*GaussParams(3).*GaussParams(5)); % Estimate Poisson noise within column by square root of mean number of counts in image.
