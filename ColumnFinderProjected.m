function [Peaks, RefinedPeaks]=ColumnFinderProjected(Series, RefinedLattice, PeakfindWindow, CentroidWindow, GaussWindow, Guess, lb, ub, Noise, RoseCriterion)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% %%%                                 INPUTS
%
...
%     MFSeries=medfilt2(Series,[m,n]);
    pk2 = locmax(Series,RefinedLattice,PeakfindWindow);
    cent = cntrd(Series,pk2,CentroidWindow);
    Gauss = iterategauss2d(Series,cent,GaussWindow, Guess, lb, ub, Noise, RoseCriterion);
    Peaks(:,:) = Gauss(:,:);
    sizeP = size(Peaks);
    ...
    print("This code only works on Projected Images"); 
end
end